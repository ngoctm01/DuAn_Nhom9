...
namespace ProjectViews.Areas.User.Controllers
{
    ...
    public class PaymentController : Controller
    {
        ...
        public async Task<IActionResult> Show()
        {
            ...
            string apiUrlshoe = $"https://localhost:7110/api/ShoeDetails/get-all-shoeDetails";
            ...
            string apiURLSizeShoe = $"https://localhost:7110/api/SIzes_ShoeDetails/get-all-size-shoe-details";
            ...
            string apiImage = $"https://localhost:7110/api/Images/get-all-image";
            ...
            string apiURLPayMethod = $"https://localhost:7110/api/PaymentMethod";
            ...
            string apiURLCartDetail = $"https://localhost:7110/api/CartDetail";
            ...
            string apiURL = $"https://localhost:7110/api/Coupons/Show-Coupons";
            var response = await _httpClient.GetAsync(apiURL);
            var apiData = await response.Content.ReadAsStringAsync();
            var coupons = JsonConvert.DeserializeObject<List<Coupons>>(apiData);

            // Lay danh sach cac ShipMethod
            string apiURLAddress = $"https://localhost:7110/api/ShipMethod";
        ...
        public async Task<IActionResult> ConfirmPay(Guid idShipMethod, Guid idPaymentMethod, string fullname, string sdt, string tinh, string huyen, string xa, string duong, string diachi, Guid idCoupon)
        {
            ...
            string apiURL = $"https://localhost:7110/api/Location/Createlocation?stage={tinh}&District={huyen}&ward={xa}&street={duong}&Address={diachi}";
            ...
            string apiURLCart = $"https://localhost:7110/api/CartDetail";
            ...
            // Get all location
            string apiUrlLocation = $"https://localhost:7110/api/Location";
            ...
            foreach (var item in cartDetailsByUser)
            {
                ...
                if (shoeDetail != null)
                {
                    ...
                    string urlApiShoeUpdateQTT = $"https://localhost:7110/api/ShoeDetails/update-quantity-by-id?id={shoeDetail.Id}&quantity={quantity}";
            ...
            string apiURLCreateBill = $"https://localhost:7110/api/Bill/CreateBill?idBill={newBill.Id}&IdUser={User.Id}&Note=abc&status=1&IdCoupon={idCoupon}&IdShipMethod={idShipMethod}&IdLocation={location.Id}&IdPaymentMethod={idPaymentMethod}";
            ...
            foreach (var item in cartDetailsByUser)
            {
                ...
                string apiURLCreateBillDT = $"https://localhost:7110/api/BillDetails?IdShoeDetail={item.IdShoeDetail}&IdBill={newBillDetails.IdBill}&price={shoeDetail.SellPrice}&quantity={item.Quantity}";
            ...
            {
                string apiURLCartDelete = $"https://localhost:7110/api/CartDetail/{cartDetailsByUser[i].Id}";
