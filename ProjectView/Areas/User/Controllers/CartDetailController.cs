...
namespace ProjectViews.Areas.User.Controllers
{
    ...
    public class CartDetailController : Controller
    {
        ...
        public async Task<IActionResult> Show()
        {
            ...
            string apiURL = $"https://localhost:7110/api/CartDetail";
            ...
            string apiSize_shoe = $"https://localhost:7110/api/SIzes_ShoeDetails/get-all-size-shoe-details";
            string apiSize = $"https://localhost:7110/api/Size/get-all-size";
        ...
        //{
        //    string apiURL = $"https://localhost:7110/api/CartDetail/{Id}";
        //    var response = await _httpClient.GetAsync(apiURL);
        //    var apiData = await response.Content.ReadAsStringAsync();
        ...
        {
            string apiURL = $"https://localhost:7110/api/CartDetail/create-cartdetail?IdUser={cartDetails.IdUser}&IdShoesDetail={cartDetails.IdShoeDetail}&Quantity={cartDetails.Quantity}";
        ...
        {
            string apiURL = $"https://localhost:7110/api/CartDetail/update-cartdetail?id={cartDetails.Id}&idShoeDetail={cartDetails.IdShoeDetail}&idUser={cartDetails.IdUser}&quantity={cartDetails.Quantity}";
        ...
        public async Task<IActionResult> AddToCart(CartViewModel a)
        {
            ...
            string apiUrl = $"https://localhost:7110/api/CartDetail/create-cartdetail";
