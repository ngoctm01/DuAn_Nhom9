...
namespace ProjectViews.Areas.User.Controllers
{
    ...
    public class DetailController : Controller
    {
        ...
        public async Task<IActionResult> DetailProduct(string name)
        {
            nameShoe = name;
            // Get all bill
            var apiUrls = "https://localhost:7110/api/ShoeDetails/get-all-shoeDetails";
            ...
            // Get all Sale Event
            var apiURLss = "https://localhost:7110/api/Sales/Show-Sales";
            ...
            var apiUrlcolr = "https://localhost:7110/api/Color/get-all-colors";
            ...
            var apiUrlsize = "https://localhost:7110/api/Size/get-all-size";
            ...
            var apiUrlbrand = "https://localhost:7110/api/Brand/get-all-brands";
            ...
            var apiUrlsize_shoeDetail = "https://localhost:7110/api/SIzes_ShoeDetails/get-all-size-shoe-details";
            ...
            var apiUrlcolor_shoeDetail = "https://localhost:7110/api/Color_ShoeDetails/get-all-color_shoeDetails";
            ...
            string apiUrlDescriptionsGetAll = $"https://localhost:7110/api/Descriptions/get-all";
            ...
            string apiUrlFeedbackGetAll = $"https://localhost:7110/api/Feedbacks/get-all-feedbacks";
        ...
        public async void GetFeedback(string name)
        {
            ...
            string apiURL = $"https://localhost:7110/api/Feedbacks/get-all-feedbacks";
            var response = await _httpClient.GetAsync(apiURL);
        ...
        public async void GetShoe(string color , float size)
        {
            ...
            string apiUrl = $"https://localhost:7110/api/ShoeDetails/get-shoeDetails-by-Color-Size?colorName={color}&sizeNumber={size}";
            var response = await _httpClient.GetAsync(apiUrl);
            var apiData = await response.Content.ReadAsStringAsync();
