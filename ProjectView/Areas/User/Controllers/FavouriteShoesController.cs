...
namespace ProjectViews.Areas.User.Controllers
{
    ...
    public class FavouriteShoesController : Controller
    {
        ...
        public async Task<IActionResult> Show()
        {
            ...
            string apiURL = $"https://localhost:7110/api/FavouriteShoes";
        ...
        {
            string apiURL = $"https://localhost:7110/api/FavouriteShoes/{Id}";
            var response = await _httpClient.GetAsync(apiURL);
            var apiData = await response.Content.ReadAsStringAsync();
        ...
        {
            string apiURL = $"https://localhost:7110/api/FavouriteShoes/create-favouriteshoes?idUser={favouriteShoes.IdUser}&idShoes={favouriteShoes.IdShoeDetail}&status={favouriteShoes.Status}";
        ...
        {
            string apiURL = $"https://localhost:7110/api/FavouriteShoes/edit-favouriteshoes?id={Id}&idUser={favouriteShoes.IdUser}&idShoesDetail={favouriteShoes.IdShoeDetail}&status={favouriteShoes.Status}";
