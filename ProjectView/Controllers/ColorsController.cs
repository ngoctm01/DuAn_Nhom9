...
namespace ProjectViews.Controllers
{
    ...
    public class ColorsController : Controller
    {
        ...
        {
            string apiUrl = "https://localhost:7110/api/Color/get-all-colors";
        ...
        public async Task<IActionResult> Create(Colors colors)
        {
            ...
            string apiUrl = $"https://localhost:7110/api/Color/create-color?colorName={colors.ColorName.TrimStart('#')}";
        ...
        {
            string apiUrl = $"https://localhost:7110/api/Color/get-color-by-id/{id}";
            var response = await _httpClient.GetAsync(apiUrl);
            string apidata = await response.Content.ReadAsStringAsync();
        ...
        {
            string apiUrl = $"https://localhost:7110/api/Color/update-color-by-id?Id={clors.Id}&colorName={clors.ColorName.TrimStart('#')}";
        ...
        {
            string apiUrl = $"https://localhost:7110/api/Color/delete-color-by-id?Id={id}";
