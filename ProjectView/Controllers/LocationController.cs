...
namespace ProjectViews.Controllers
{
    public class LocationController  :Controller
    {
        ...
        public async Task<IActionResult> ShowAllLocation(int? page, int? pageSize)
        {
            ...
            string apiUrl = $"https://localhost:7110/api/Location";
        ...
        {
            //string apiURL = $"https://localhost:7110/api/Location?stage={location.Stage}&District={location.District}&ward={location.Ward}&street={location.Street}&Address={location.Address}";          
            ...
            string apiURL = $"https://localhost:7110/api/Location/Createlocation?stage={location.Stage}&District={location.District}&ward={location.Ward}&street={location.Street}&Address={location.Address}";
        ...
        {
            string apiURL = $"https://localhost:7110/api/Location/{Id}";
            var response = await _httpClient.GetAsync(apiURL);
            string apidata = await response.Content.ReadAsStringAsync();
        ...
        {
            string apiURL = $"https://localhost:7110/api/Location/updateLocation?Id={Id}&stage={location.Stage}&District={location.District}&ward={location.Ward}&street={location.Street}&Address={location.Address}";
            var content = new StringContent(JsonConvert.SerializeObject(location), Encoding.UTF8, "application/json");
        ...
        {
            string apiURL = $"https://localhost:7110/api/Location/deleteLocation/{Id}";
