...
namespace ProjectViews.Controllers
{
    public class DescriptionController : Controller
    {
       private readonly HttpClient _httpClient;
        ...
        {
            string apiUrl = $"https://localhost:7110/api/Descriptions/get-all";
        ...
        {
            string apiUrl =
                $"https://localhost:7110/api/Descriptions/create-description?idShoesDetails={des.IdShoeDetail}&note1={des.Note1}&note2={des.Note2}&note3={des.Note3}";
        ...
        {
            string url = $"https://localhost:7110/api/Descriptions/get-by-id?id={iD}";
        ...
        {
            string url = $"https://localhost:7110/api/Descriptions/update-description?id={des.Id}&note1={des.Note1}&note2={des.Note2}&note3={des.Note3}&idShoesDetail={des.IdShoeDetail}";
        ...
        {
            string apiUrl = $"https://localhost:7110/api/Descriptions/delete-description?id={id}";
