...
namespace ProjectViews.Controllers
{
    public class CouponsController:Controller
    {
        ...
        {
            string apiURL = $"https://localhost:7110/api/Coupons/{Id}";
            var response = await _httpClient.GetAsync(apiURL);
            var apiData = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> Create(Coupons coupons)
        {
            ...
            string apiURL = $"https://localhost:7110/api/Coupons/Create-Coupons?DiscountValue={coupons.DiscountValue}&Quantity={coupons.Quantity}&VoucherName={coupons.VoucherName}";
        ...
        public async Task<IActionResult> Edit(Guid Id, Coupons coupons)
        {
            ...
            string apiURL = $"https://localhost:7110/api/Coupons/edit-Coupons-{Id}?DiscountValue={coupons.DiscountValue}&Quantity={coupons.Quantity}&VoucherName={coupons.VoucherName}&TimeStart={coupons.TimeStart}&TimeEnd={formattedEndDate}";
        ...
        {
            string apiURL = $"https://localhost:7110/api/Coupons/Delete-Coupons-/{Id}";
