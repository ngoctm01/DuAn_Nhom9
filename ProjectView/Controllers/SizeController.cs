...
namespace ProjectViews.Controllers
{
    public class SizeController : Controller
    {
        ...
        {
            string apiURL = $"https://localhost:7110/api/Size/get-all-size";
        ...
        public async Task<IActionResult> CreateSize(Sizes sizes)
        {
            ...
            string apiURL = $"https://localhost:7110/api/Size/create-size?sizeNumberCreate={sizes.SizeNumber}";
        ...
        {
            string apiURL = $"https://localhost:7110/api/Size/get-size-by-id/{id}";
            var response = await _httpClient.GetAsync(apiURL);
            string apiData = await response.Content.ReadAsStringAsync();
        ...
        {
            string apiURL = $"https://localhost:7110/api/Size/update-size-by-id?id={sizes.Id}&sizeNumberUpdate={sizes.SizeNumber}";
            var content = new StringContent(JsonConvert.SerializeObject(sizes), Encoding.UTF8, "application/json");
        ...
        {
            string apiURL = $"https://localhost:7110/api/Size/delete-size-by-id?id={id}";
