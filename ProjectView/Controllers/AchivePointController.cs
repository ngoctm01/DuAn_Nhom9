...
namespace ProjectViews.Controllers
{
    public class AchivePointController : Controller
    {
        ...
        {
            string apiURL = $"https://localhost:7110/api/AchivePoints/get-all-achivepoint";
        ...
        {
            string apiURL = $"https://localhost:7110/api/AchivePoints/{Id}";
            var response = await _httpClient.GetAsync(apiURL);
            var apiData = await response.Content.ReadAsStringAsync();
        ...
        {
            string apiURL = $"https://localhost:7110/api/AchivePoints/create-achivepoint?IdUser={achivePoint.IdUser}&PointValue={achivePoint.PointValue}";
        ...
        {
            string apiURL = $"https://localhost:7110/api/AchivePoints/update-achivepoint?Id={Id}&IdUser={achivePoint.IdUser}&PointValue={achivePoint.PointValue}";
            var content = new StringContent(JsonConvert.SerializeObject(achivePoint), Encoding.UTF8, "application/json");
        ...
        {
            string apiURL = $"https://localhost:7110/api/AchivePoints/delete-achivepoint?Id={Id}";
