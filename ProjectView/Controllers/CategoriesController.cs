...
namespace ProjectViews.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        {
            string apiUrl = $"https://localhost:7110/api/Categories/create-category?categoryName={categories.CategoryName}";
        ...
        {
            string apiUrl = $"https://localhost:7110/api/Categories/get-categories-by-id?id={id}";
            var response = await _httpClient.GetAsync(apiUrl);
            string apidata = await response.Content.ReadAsStringAsync();
        ...
        {
            string apiUrl = $"https://localhost:7110/api/Categories/update-category?id={categories.Id}&categoryName={categories.CategoryName}";
            var content = new StringContent(JsonConvert.SerializeObject(categories), Encoding.UTF8, "application/json");
        ...
        {
            string apiUrl = $"https://localhost:7110/api/Categories/delete-category?id={id}";
