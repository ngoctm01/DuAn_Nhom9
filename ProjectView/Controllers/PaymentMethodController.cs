...
namespace ProjectViews.Controllers
{
    public class PaymentMethodController : Controller
    {
        ...
        {
            string apiURL = $"https://localhost:7110/api/PaymentMethod";
        ...
        {
            string apiURL = $"https://localhost:7110/api/PaymentMethod/{Id}";
            var response = await _httpClient.GetAsync(apiURL);
            var apiData = await response.Content.ReadAsStringAsync();
        ...
        {
            string apiURL = $"https://localhost:7110/api/PaymentMethod/CreatePaymentMethod?status={paymentMethods.Status}&Name={paymentMethods.NameMethod}";
        ...
        {
            string apiURL = $"https://localhost:7110/api/PaymentMethod/UpdatePaymentMethod?id={Id}&status={paymentMethod.Status}&Name={paymentMethod.NameMethod}";
        ...
        {
            string apiURL = $"https://localhost:7110/api/PaymentMethod/Delete?id={Id}";
