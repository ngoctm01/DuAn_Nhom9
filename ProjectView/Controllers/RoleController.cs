...
namespace ProjectViews.Controllers
{
    public class RoleController : Controller
    {
        ...
        {
            string apiURL = $"https://localhost:7110/api/Role/{Id}";
            var response = await _httpClient.GetAsync(apiURL);
            var apiData = await response.Content.ReadAsStringAsync();
        ...
        {
            string apiURL = $"https://localhost:7110/api/Role/create-role?RoleName={roles.RoleName}&Status={roles.Status = 1}";
        ...
        {
            string apiURL = $"https://localhost:7110/api/Role/Edit-role-by-id?Id={Id}&RoleName={roles.RoleName}&Status={roles.Status}";
            var content = new StringContent(JsonConvert.SerializeObject(roles), Encoding.UTF8, "application/json");
        ...
        {
            string apiURL = $"https://localhost:7110/api/Role/delete-role-by-id?Id={Id}";
